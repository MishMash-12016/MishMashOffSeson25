...
import org.firstinspires.ftc.teamcode.CommendGroups.Camera.CameraCommandGroups;
...
@Config
@AutoLog
public class LamlamTestOpMode extends MMOpMode {

    public LamlamTestOpMode() {
    ...
    public void onInit() {
        ...
        MMRobot.getInstance().gamepadEx1.getGamepadButton(GamepadKeys.Button.Y).whenPressed(
                CameraCommandGroups.CameraSampleIntake()
        );

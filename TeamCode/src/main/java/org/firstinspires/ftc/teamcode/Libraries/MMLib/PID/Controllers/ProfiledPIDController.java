...
public class ProfiledPIDController {
  ...
  public double getVelocityTolerance() {
    return m_controller.getErrorRateTolerance();
  }
  ...
  public void setMaxVelocity(double maxVelocity){
    m_constraints = new TrapezoidProfile.Constraints(maxVelocity, m_constraints.maxAcceleration);
    m_profile = new TrapezoidProfile(m_constraints);
  }

  public void setMaxAcceleration(double maxAcceleration){
    m_constraints = new TrapezoidProfile.Constraints(m_constraints.maxVelocity, maxAcceleration);
    m_profile = new TrapezoidProfile(m_constraints);
  }
  ...
  public Double getMinimumIntegral(){
    return m_controller.getMinimumIntegral();
  }

  public Double getMaximumIntegral(){
    return m_controller.getMaximumIntegral();
  }
   ...
   */
  public TrapezoidProfile.State getStateSetpoint() {
    return m_setpoint;
  }
  ...
  public double getVelocityError() {
    return m_controller.getErrorRate();
  }
  ...
  public double calculate(double measurement) {
    if (m_controller.isContinuousInputEnabled()) {
      ...
      double goalMinDistance =
              MMUtils.inputModulus(m_goal.position - measurement, -errorBound, errorBound);
      double setpointMinDistance =
              MMUtils.inputModulus(m_setpoint.position - measurement, -errorBound, errorBound);

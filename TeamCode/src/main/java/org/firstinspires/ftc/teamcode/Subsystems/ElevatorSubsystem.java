...
public class ElevatorSubsystem extends PositionPidSubsystem {
    ...
    public static double ELEVATOR_HIGH_BASKET = 48;
    public static double ELEVATOR_DOWN_POSITION = 0.0;
    public static double ELEVATOR_CLIMB_HIGH_BAR = 64;
    public static double ELEVATOR_ZERO = 0.0;
    public static double ELEVATOR_CLIMB_POSITION = 40;
    ...
    public ElevatorSubsystem(String subsystemName) {
        ...
        withEncoder(mmRobot.expansionHub,3,27.46, Direction.REVERSE);
